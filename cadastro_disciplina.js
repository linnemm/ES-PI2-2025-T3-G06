...
// Seeds (remova se já estiver vindo do back-end)
...
JSON.parse(localStorage.getItem(LS_INST) || '[]').forEach(i => $('instituicao').append(new Option(i,i)));
JSON.parse(localStorage.getItem(LS_CURSO) || '[]').forEach(c => $('curso').append(new Option(c,c)));
}
